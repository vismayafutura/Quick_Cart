    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="add-category.php">Add Category</a></li>

          <li class="dropdown"><a href="#"><span>Manage Product</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
          ...
          <li><a class="nav-link scrollto" href="feedback1.php">feedback</a></li>
